This repository provides a SAS macro (`checkdigit.sas`) that implements the Gumm/Verhoeff check digit algorithm, along with an example driver program (`run_checkdigit.sas`).

The Gumm/Verhoeff check digit algorithm adds an extra digit to a number to help detect common data-entry errors:
